...
class WXDetailActivity : AppCompatActivity() {
    ...
    private fun initView() {
        ...
        for (index in 1..56) {
            ...
            if (index == 17) set.add(R.drawable.profile_32)
        }
        ...
        findViewById<TextView>(R.id.time_text).text = "2024年4月16号 16:22"
        findViewById<TextView>(R.id.title_text).text = "\uD83C\uDF08合肥蜀山向日葵幼儿园#快乐学英语\uD83D\uDD14叮咚～英语广播站来啦More English，more fun！以最快乐的方式[太阳]  让孩子爱上英语，在欢笑中成长，在快乐中感受美妙的童年世界[爱心]在英语律动中学会自由放松的表达自己\uD83C\uDF88See you next time.联系电话：15391930991地址：井岗路与蜀苑路交口（剑桥高中对面）"
        findViewById<ImageView>(R.id.task_image).setImageResource(R.drawable.task_20240416)
        ...
        // commentDataList.add(comment)
        comment = Comment(R.drawable.profile_32, "刘杰 - 商米", "我要开始收费了", "2024年4月16号 19:35")
        commentDataList.add(comment)
